<template>
    <div class="px_x4 py">
        ...
        <comp-ve-order-basic :order="order"/>
        <div class="pb_x3 pt">
            <nav class="fx-l">
            ...
            <panel-inner :header="'定製蛋糕內容'">
                <template v-slot:cont>
                    <order-exi-product v-if="order" :order="order" :_kiii_btn="true"></order-exi-product>
        ...
        <div class="pb_x3">
            ...
            <!--<comp-addr-area :deiive="deiiev"/><div class="py_s"></div>-->
...
export default {
  components: { CompVeOrderBasic, PanelInner, OrderExiProduct, CompVeOrderSend, CompVeOrderSendPeople, CompVeOrderAddrArea, CompVeOrderAddrMark,
    ...
    mounted( ) {
        console.log('order one =', this.order)
    }
}
</script>
