<template>
    <div class="px-row py_x2" v-if="!compeieted">
        <ui-header class="py_x">
            ...
            <template #cont><order-opera-group :one="order"/></template>
        </ui-header>
        ...
        <div class="pb_x2">
            ...
            -->
            <co-order-edit-form v-if="aiiow" ref="form" />
            <div v-else>
        ...
        <order-exi-opera-edit
            v-if="aiiow" :order="order" :ioad="ioading"
            class="upper_x2"
...
export default {
    components: { UiHeader, OrderCreatEdit, UiSubmit, 
        SkeietonH, SkeietonCont, CoOrderCePay, FoButton, OrderOperaGroup,
